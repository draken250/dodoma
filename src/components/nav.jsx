...
<div className="hidden md:flex justify-between items-center bg-gray-100 px-4 py-2 text-sm text-gray-600">
    ...
    <div className="flex space-x-4">
        <a href="#" className="hover:text-gray-800">Tracking Package</a>
...
<div className="flex items-center justify-between bg-white px-6 py-4 border-b border-gray-200">
    ...
    <div className="hidden md:flex items-center space-x-6 text-gray-700">
        ...
        <div className="relative">
            <input type="text" placeholder="Search here" className="w-64 pl-4 pr-10 py-2 border rounded-full text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500"/>
        ...
        <div className="flex items-center space-x-6">
            ...
            <a href="#" className="hover:text-gray-900">Special Event</a>
        </div> 
        <div className="flex items-center space-x-6">
...
<div id="mobileMenu" className="md:hidden hidden bg-white border-t border-gray-200">
    <div className="flex flex-col p-4 space-y-4 text-gray-700">
        <input type="text" placeholder="Search here" className="w-full pl-4 pr-10 py-2 border rounded-full text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500"/>
        <a href="#" className="hover:text-gray-900">All Category</a>
        <a href="#" className="hover:text-gray-900">Gift Cards</a>
        <a href="#" className="hover:text-gray-900">Special Event</a>
        <a href="#" className="hover:text-gray-900">Tracking Package</a>
